...
<h2 class="fringe">
    El siguiente cuadro muestra la auto-evaluación, así como la
    evaluación del jefe, los pares y los supervisores, representado en
    colores
</h2>
<table align="center" border="0" cellpadding="1" cellspacing="1" style="width:800px;">
    ...
    <tr>
        <td rowspan="6">Organizacionales</td>
    ...
    <tr>
        <td>Seguridad en el Entorno de Trabajo</td>
        <td>4.00</td>
        <td>4.22</td>
        <td>4.39</td>
        <td>4.33</td>
...
<table class="table-no-bordered" width="100%">
    ...
    <tr>
        <td>
            <div class="fringe-status success">4.00 - 5.00</div>
        </td>
        <td>La competencia se califica: desarrollada.</td>
    ...
    <tr>
        <td>
            <div class="fringe-status warning">3.00 - 3.99</div>
        </td>
        <td>La competencia se califica: con desempeño deficiente</td>
        <td style="padding-left: 15px;"></td>
    </tr>
    <tr>
        <td>
            <div class="fringe-status danger">1.00 - 2.99</div>
        </td>
        <td>La competencia se califica: no desarrollada</td>
        <td style="padding-left: 15px;"></td>
    </tr>
