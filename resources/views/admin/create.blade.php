            ...
            <div class="modal-content">
               <div class="modal-header">
                  ...
                  <div class="modal-body">
                     ...
                     <button class="btn btn-info btn-xs btn-flat separate" data-bind="click: toggleAdmin"><i class="fa fa-plus"></i> Asignar Empresas</button>
                     ...
                     <div class="row" data-bind="visible: showFormAdminTest">
                        <div class="col-xs-12">
                           <button class="btn btn-primary btn-sm btn-flat" data-bind="click: toggleformCompany, visible: !formCompany()">Agregar Empresa</button>
                           <div class="col-xs-12" data-bind="visible: formCompany">
                              ...
                              <button class="btn btn-primary btn-sm btn-flat pull-right" data-bind="click: toggleformCompany">Enviar Datos</button>
                           </div>
                           <div class="table-responsive">
                              <table class="table table-striped">
                                 <thead>
