            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="col-xs-12" data-bind="visible: showForm">
                        {!! Form::open(
                            array(
                                'route' => 'admin.niveles.store',
                                'class' => 'form',
                                'novalidate' => 'novalidate',
                                )) !!}

                        <div class="form-group separate col-xs-6 col-md-4">
                            {!! Form::label('Nombre del Nivel') !!}
                            {!! Form::text('name',null ,['class' => 'form-control']) !!}
                        </div>


                        <div class="form-group col-xs-12 separate">
                            {!! Form::submit('Crear Nivel', ['class' => 'btn btn-info pull-right']) !!}
                        </div>
                        {!! Form::close() !!}
                    </div>
                    ...
                    <div class="table-responsive" data-bind="visible: !showForm()">
                        <table id="" class="table table-bordered table-striped">
                            <thead>
                            <tr>
                                <th class="col-xs-2 text-center">Nombre del Nivel</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
